...
class MTConnectAdapter(object): # MTConnect adapter object
    ...
    def __init__(self, host, port): # init of MTconnectAdapter class
        ...
        # Virtual sensor (random humidity value)
        self.h1 = Sample('h1') # self.h1 takes 'h1' sample data item id.
        ...
        self.avail_s2 = Event('avail_s2')
        self.avail_s3 = Event('avail_s3')
        self.adapter.add_data_item(self.avail_s2)
        self.adapter.add_data_item(self.avail_s3)

        # Start MTConnect
        self.adapter.start()
        self.adapter.begin_gather()
        self.avail_s2.set_value("AVAILABLE")
        self.avail_s3.set_value("AVAILABLE")
    ...
    def adapter_stream(self):
        while True:
            try:
                ...
                h1 = random.uniform(50, 70) # Humidity (random input 50% - 70%)
...
if __name__ == "__main__":   
    ...
    MTConnectAdapter('0.0.0.0', 7878) # Args: host ip, port number
