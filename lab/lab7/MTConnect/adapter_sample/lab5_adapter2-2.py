...
class MTConnectAdapter(object): # MTConnect adapter object
    ...
    def __init__(self, host, port): # init of MTconnectAdapter class
        ...
        self.a3 = Sample('a3') # self.a1 takes 'a3' sample data item id.
        ...
        self.avail_s1 = Event('avail_s1')
        self.adapter.add_data_item(self.avail_s1)

        # Start MTConnect
        self.adapter.start()
        self.adapter.begin_gather()
        self.avail_s1.set_value("AVAILABLE")
...
if __name__ == "__main__":
    ...
    MTConnectAdapter('0.0.0.0', 7879) # Args: host ip, port number
